...
/**
 * {@link EnableAutoConfiguration Auto-configuration} for Spring Batch. By
 * default a Runner will be created and all jobs in the context will be executed
 * on startup.
 * <p>
 * Disable this behavior with {@literal spring.batch.job.enabled=false}).
 * <p>
 * Alternatively, discrete Job names to execute on startup can be supplied by
 * the User with a comma-delimited list:
 * {@literal spring.batch.job.names=job1,job2}. In this case the Runner will
 * first find jobs registered as Beans, then those in the existing JobRegistry.
 *
 * @author Dave Syer
...
public class BatchAutoConfiguration {
	...
	// public BatchDatabaseInitializer batchDatabaseInitializer(DataSource
	// dataSource,
	// ResourceLoader resourceLoader) {
	// return new BatchDatabaseInitializer(dataSource, resourceLoader,
	// this.properties);
	// }
	...
	public SimpleJobOperator jobOperator(JobExplorer jobExplorer, JobLauncher jobLauncher, ListableJobLocator jobRegistry,
...
//		}
//
//		// The EntityManagerFactory may not be discoverable by type when this
//		// condition
//		// is evaluated, so we need a well-known bean name. This is the one used
//		// by Spring
